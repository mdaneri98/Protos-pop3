...
LIB_OBJS = $(LIB_DIR)/buffer.o $(LIB_DIR)/netutils.o $(LIB_DIR)/parser.o $(LIB_DIR)/selector.o $(LIB_DIR)/stm.o
SERVER_OBJS = $(SERVER_DIR)/args/args.o $(SERVER_DIR)/parser/pop3_parser.o $(SERVER_DIR)/stm/pop3_stm.o $(SERVER_DIR)/main.o
